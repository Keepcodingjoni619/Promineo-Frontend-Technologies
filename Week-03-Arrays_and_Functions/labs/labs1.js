...
myTodoList.push("Learn Javascript", "Become a Frontend Developer", "Finish School");
...
let yourTodoList = ["Complete Assignments", "Graduate Promineo"];

// create another array, ourTodoList
const ourTodoList = ["study"];
// combine myTodoList and yourTodoList into ourTodoList

ourTodoList.concat(myTodoList,yourTodoList);
